   ...
   <div class="container">
    <div class="row">
     <div class="col-md-8 mx-auto">
        <h1>筋トレlife</h1>
         @csrf
        <input type="button"  class="btn btn-primary" onclick="location.href='https://myapp-sn.dix.asia/admin/myapp/event'"value="種目名登録">
        <input type="button"  class="btn btn-primary" onclick="location.href='https://myapp-sn.dix.asia/admin/myapp/eventdetail'"value="メニュー登録">
